...
data "akamai_property_rules_builder" "devops_rule_default_ion_etls" {
  rules_v2024_10_21 {
    name      = "default"
    is_secure = var.etls
    ...
    children = compact([
      var.additional_origins != null ? data.akamai_property_rules_builder.devops_rule_additional_origins.json : null,
      data.akamai_property_rules_builder.devops_rule_augment_insights.json,
      data.akamai_property_rules_builder.devops_rule_accelerate_delivery_ion.json,
      data.akamai_property_rules_builder.devops_rule_offload_origin_etls.json,
      data.akamai_property_rules_builder.devops_rule_strengthen_security.json,
      data.akamai_property_rules_builder.devops_rule_increase_availability_ion.json,
      data.akamai_property_rules_builder.devops_rule_minimize_payload.json,
    ])
  }
}

data "akamai_property_rules_builder" "devops_rule_default_ion_stls" {
  rules_v2024_10_21 {
    name      = "default"
    is_secure = var.etls
    comments  = "The Default Rule template contains all the necessary and recommended behaviors. Rules are evaluated from top to bottom and the last matching rule wins."
    ...
    children = compact([
      ...
      data.akamai_property_rules_builder.devops_rule_augment_insights.json,
      data.akamai_property_rules_builder.devops_rule_accelerate_delivery_ion.json,
      data.akamai_property_rules_builder.devops_rule_offload_origin_stls.json,
      data.akamai_property_rules_builder.devops_rule_strengthen_security.json,
      data.akamai_property_rules_builder.devops_rule_increase_availability_ion.json,
      data.akamai_property_rules_builder.devops_rule_minimize_payload.json,
    ])
...
data "akamai_property_rules_builder" "devops_rule_default_dsa_etls" {
  rules_v2024_10_21 {
    name      = "default"
    is_secure = var.etls
    comments  = "The Default Rule template contains all the necessary and recommended behaviors. Rules are evaluated from top to bottom and the last matching rule wins."
    ...
    children = compact([
      var.additional_origins != null ? data.akamai_property_rules_builder.devops_rule_additional_origins.json : null,
      data.akamai_property_rules_builder.devops_rule_augment_insights.json,
      data.akamai_property_rules_builder.devops_rule_accelerate_delivery_dsa.json,
      data.akamai_property_rules_builder.devops_rule_offload_origin_etls.json,
      data.akamai_property_rules_builder.devops_rule_strengthen_security.json,
      data.akamai_property_rules_builder.devops_rule_increase_availability_dsa.json,
      data.akamai_property_rules_builder.devops_rule_minimize_payload.json,
    ])
  }
}

data "akamai_property_rules_builder" "devops_rule_default_dsa_stls" {
  rules_v2024_10_21 {
    name      = "default"
    is_secure = var.etls
    comments  = "The Default Rule template contains all the necessary and recommended behaviors. Rules are evaluated from top to bottom and the last matching rule wins."
...
data "akamai_property_rules_builder" "devops_rule_augment_insights" {
  rules_v2024_10_21 {
    ...
    children = [
      data.akamai_property_rules_builder.devops_rule_traffic_reporting.json,
      data.akamai_property_rules_builder.devops_rule_m_pulse_rum.json,
      data.akamai_property_rules_builder.devops_rule_geolocation.json,
      data.akamai_property_rules_builder.devops_rule_log_delivery.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_accelerate_delivery_dsa" {
  rules_v2024_10_21 {
    ...
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.devops_rule_origin_connectivity.json,
      data.akamai_property_rules_builder.devops_rule_protocol_optimizations_dsa.json,
      data.akamai_property_rules_builder.devops_rule_prefetching.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_accelerate_delivery_ion" {
  rules_v2024_10_21 {
    name                  = "Accelerate delivery"
    comments              = "Control the settings related to improving the performance of delivering objects to your users."
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.devops_rule_origin_connectivity.json,
      data.akamai_property_rules_builder.devops_rule_protocol_optimizations_ion.json,
      data.akamai_property_rules_builder.devops_rule_prefetching.json,
      data.akamai_property_rules_builder.devops_rule_adaptive_acceleration.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_offload_origin_stls" {
  rules_v2024_10_21 {
    name                  = "Offload origin"
    ...
    children = [
      data.akamai_property_rules_builder.devops_rule_css_and_java_script.json,
      data.akamai_property_rules_builder.devops_rule_fonts.json,
      data.akamai_property_rules_builder.devops_rule_images.json,
      data.akamai_property_rules_builder.devops_rule_files.json,
      data.akamai_property_rules_builder.devops_rule_other_static_objects.json,
      data.akamai_property_rules_builder.devops_rule_html_pages.json,
      data.akamai_property_rules_builder.devops_rule_redirects.json,
      data.akamai_property_rules_builder.devops_rule_post_responses.json,
      data.akamai_property_rules_builder.devops_rule_graph_ql.json,
      data.akamai_property_rules_builder.devops_rule_uncacheable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_offload_origin_etls" {
  rules_v2024_10_21 {
    name                  = "Offload origin"
    comments              = "Control the settings related to caching content at the edge and in the browser. As a result, fewer requests go to your origin, fewer bytes leave your data centers, and your assets are closer to your users."
    criteria_must_satisfy = "all"
...
data "akamai_property_rules_builder" "devops_rule_strengthen_security" {
  rules_v2024_10_21 {
    ...
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.devops_rule_allowed_methods.json,
      data.akamai_property_rules_builder.devops_rule_obfuscate_debug_info.json,
      data.akamai_property_rules_builder.devops_rule_obfuscate_backend_info.json,
      data.akamai_property_rules_builder.devops_rule_hsts.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_increase_availability_dsa" {
  rules_v2024_10_21 {
    ...
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.devops_rule_simulate_failover.json,
      data.akamai_property_rules_builder.devops_rule_site_failover.json,
      data.akamai_property_rules_builder.devops_rule_origin_health.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_increase_availability_ion" {
  rules_v2024_10_21 {
    name                  = "Increase availability"
    comments              = "Control how to respond when your origin or third parties are slow or even down to minimize the negative impact on user experience."
    criteria_must_satisfy = "all"
    children = [
      ...
      data.akamai_property_rules_builder.devops_rule_site_failover.json,
      data.akamai_property_rules_builder.devops_rule_origin_health.json,
      data.akamai_property_rules_builder.devops_rule_script_management.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_minimize_payload" {
  rules_v2024_10_21 {
    ...
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.devops_rule_compressible_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_traffic_reporting" {
  rules_v2024_10_21 {
    ...
    behavior {
      cp_code {
        value {
          id       = tonumber(trimprefix(akamai_cp_code.this.id, "cpc_"))
...
data "akamai_property_rules_builder" "devops_rule_m_pulse_rum" {
  rules_v2024_10_21 {
    name                  = "mPulse RUM"
...
data "akamai_property_rules_builder" "devops_rule_geolocation" {
  rules_v2024_10_21 {
    name                  = "Geolocation"
...
data "akamai_property_rules_builder" "devops_rule_log_delivery" {
  rules_v2024_10_21 {
    name                  = "Log delivery"
...
data "akamai_property_rules_builder" "devops_rule_origin_connectivity" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_protocol_optimizations_dsa" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_protocol_optimizations_ion" {
  rules_v2024_10_21 {
    name                  = "Protocol optimizations"
    comments              = "Serve your website using modern and fast protocols."
    criteria_must_satisfy = "all"
...
data "akamai_property_rules_builder" "devops_rule_prefetching" {
  rules_v2024_10_21 {
    name                  = "Prefetching"
    comments              = "Instruct edge servers to retrieve embedded resources before the browser requests them."
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.devops_rule_prefetching_objects.json,
      data.akamai_property_rules_builder.devops_rule_prefetchable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_adaptive_acceleration" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_prefetching_objects" {
  rules_v2024_10_21 {
    ...
    children = [
      data.akamai_property_rules_builder.devops_rule_bots.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_prefetchable_objects" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_bots" {
  rules_v2024_10_21 {
    name                  = "Bots"
...
data "akamai_property_rules_builder" "devops_rule_css_and_java_script" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_fonts" {
  rules_v2024_10_21 {
    name                  = "Fonts"
...
data "akamai_property_rules_builder" "devops_rule_images" {
  rules_v2024_10_21 {
    name                  = "Images"
...
data "akamai_property_rules_builder" "devops_rule_files" {
  rules_v2024_10_21 {
    name                  = "Files"
...
data "akamai_property_rules_builder" "devops_rule_other_static_objects" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_html_pages" {
  rules_v2024_10_21 {
    name                  = "HTML pages"
...
data "akamai_property_rules_builder" "devops_rule_redirects" {
  rules_v2024_10_21 {
    name                  = "Redirects"
...
data "akamai_property_rules_builder" "devops_rule_post_responses" {
  rules_v2024_10_21 {
    name                  = "POST responses"
...
data "akamai_property_rules_builder" "devops_rule_graph_ql" {
  rules_v2024_10_21 {
    name                  = "GraphQL"
...
data "akamai_property_rules_builder" "devops_rule_uncacheable_objects" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_allowed_methods" {
  rules_v2024_10_21 {
    ...
    children = [
      data.akamai_property_rules_builder.devops_rule_post.json,
      data.akamai_property_rules_builder.devops_rule_options.json,
      data.akamai_property_rules_builder.devops_rule_put.json,
      data.akamai_property_rules_builder.devops_rule_delete.json,
      data.akamai_property_rules_builder.devops_rule_patch.json,
    ]
  }
}

data "akamai_property_rules_builder" "devops_rule_obfuscate_debug_info" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_obfuscate_backend_info" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_hsts" {
  rules_v2024_10_21 {
    name                  = "HSTS"
...
data "akamai_property_rules_builder" "devops_rule_post" {
  rules_v2024_10_21 {
    name                  = "POST"
...
data "akamai_property_rules_builder" "devops_rule_options" {
  rules_v2024_10_21 {
    name                  = "OPTIONS"
...
data "akamai_property_rules_builder" "devops_rule_put" {
  rules_v2024_10_21 {
    name                  = "PUT"
...
data "akamai_property_rules_builder" "devops_rule_delete" {
  rules_v2024_10_21 {
    name                  = "DELETE"
...
data "akamai_property_rules_builder" "devops_rule_patch" {
  rules_v2024_10_21 {
    name                  = "PATCH"
...
data "akamai_property_rules_builder" "devops_rule_simulate_failover" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_site_failover" {
  rules_v2024_10_21 {
    name                  = "Site failover"
...
data "akamai_property_rules_builder" "devops_rule_origin_health" {
  rules_v2024_10_21 {
    name                  = "Origin health"
...
data "akamai_property_rules_builder" "devops_rule_script_management" {
  rules_v2024_10_21 {
...
data "akamai_property_rules_builder" "devops_rule_compressible_objects" {
  rules_v2024_10_21 {
