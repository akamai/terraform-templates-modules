...
| <a name="input_datadog_connector"></a> [datadog\_connector](#input\_datadog\_connector) | Configuration for Datadog destination. | <pre>object({<br/>    display_name = string<br/>    endpoint     = string<br/>    auth_token   = string<br/>    service      = optional(string)<br/>    source       = optional(string)<br/>    tags         = optional(string)<br/>  })</pre> | `null` | no |
...
| <a name="input_enable_midgress"></a> [enable\_midgress](#input\_enable\_midgress) | Enable midgress traffic logging. | `bool` | `false` | no |
| <a name="input_log_format"></a> [log\_format](#input\_log\_format) | Format of the logs (JSON or STRUCTURED). | `string` | `"JSON"` | no |
| <a name="input_product_id"></a> [product\_id](#input\_product\_id) | Product ID (e.g., SPM for Ion). | `string` | `"SPM"` | no |
...
| <a name="input_splunk_connector"></a> [splunk\_connector](#input\_splunk\_connector) | Configuration for Splunk destination. | <pre>object({<br/>    display_name          = string<br/>    endpoint              = string<br/>    event_collector_token = string<br/>  })</pre> | `null` | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_cpcode_id"></a> [cpcode\_id](#output\_cpcode\_id) | The ID of the created CP Code. |
| <a name="output_cpcode_name"></a> [cpcode\_name](#output\_cpcode\_name) | The name of the created CP Code. |
