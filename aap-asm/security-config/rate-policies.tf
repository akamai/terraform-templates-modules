      ...
      "additionalMatchOptions" : [
        {
          ...
          "values" : var.client_lists_rcbypass
        },
        {
          "positiveMatch" : true,
...
resource "time_sleep" "wait1" {
  create_duration = "5s"
  depends_on      = [akamai_appsec_rate_policy.origin_error]
}
  ...
  rate_policy = jsonencode(
    {
      ...
      "matchType" : "path",
      "name" : "POST and PUT Page Requests",
      "pathMatchType" : "Custom",
      "pathUriPositiveMatch" : true,
...
resource "time_sleep" "wait2" {
  create_duration = "5s"
  depends_on      = [akamai_appsec_rate_policy.post_page_requests]
}
  ...
  rate_policy = jsonencode(
    {
      ...
      "fileExtensions" : {
        "positiveMatch" : false,
        "values" : [
          "aif", "aiff", "au", "avi", "bin", "bmp", "cab", "carb", "cct",
          "cdf", "class", "css", "csv", "dcr", "doc", "docx", "dtd", "ejs",
          "ejss", "eot", "eps", "exe", "flv", "gcf", "gff", "gif", "grv",
          "hdml", "hdp", "hqx", "ico", "ini", "jar", "jp2", "jpeg", "jpg",
          "js", "jxr", "mid", "midi", "mov", "mp3", "mp4", "nc", "ogv",
          "otc", "otf", "pct", "pdf", "pict", "pls", "png", "ppc", "ppt",
          "pptx", "ps", "pws", "svg", "svgz", "swa", "swf", "tif", "tiff",
          "ttc", "ttf", "txt", "vbs", "w32", "wav", "wbmp", "wdp", "webm",
          "webp", "wml", "wmlc", "wmls", "wmlsc", "woff", "woff2", "xls",
          "xlsx", "xsd", "zip"
        ]
      },
      "matchType" : "path",
